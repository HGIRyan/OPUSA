        ...
        if (str.includes("☀")) {
          ...
          let items = str.map((e, i) => {
            if (e.includes("☀")) {
              ...
              let keyword = key.filter(
                el =>
                  el.toLowerCase().includes("customer.") ||
                  el.toLowerCase().includes("company.")
              )[0];
  ...
  Standard: (comp, cust, type, format) => {
    try {
      ...
      if (type === "pr") {
        ...
        thanks = comp.pr_body.pr.thanks
          ? module.exports.keywords(comp.pr_body.pr.thanks, comp, cust)
        ...
        question = comp.or_body.or.question
          ...
          : "How likely is it that you would recommend our agency to a friend or colleague?";
        thanks = comp.or_body.or.thanks
          ? module.exports.keywords(comp.or_body.or.thanks, comp, cust)
          : "Thank you so much for your feedback.";
      } else if (type === "fr") {
        ...
        question = comp.fr_body.fr.question
          ...
          : "How likely is it that you would recommend our agency to a friend or colleague?";
        thanks = comp.fr_body.fr.thanks
          ? module.exports.keywords(comp.fr_body.fr.thanks, comp, cust)
          : "Thank you so much for your feedback.";
      } else if (type === "sr") {
        ...
        question = comp.sr_body.sr.question
          ...
          : "How likely is it that you would recommend our agency to a friend or colleague?";
        thanks = comp.sr_body.sr.thanks
          ? module.exports.keywords(comp.sr_body.sr.thanks, comp, cust)
          : "Thank you so much for your feedback.";
      } else if (type === "spr") {
        two = "2";
        ...
        question = comp.spr_body.spr.question
          ...
          : "How likely is it that you would recommend our agency to a friend or colleague?";
        thanks = comp.spr_body.spr.thanks
          ? module.exports.keywords(comp.spr_body.spr.thanks, comp, cust)
          : "Thank you so much for your feedback.";
      } else if (type === "s") {
        ...
        question = comp.s_body.s.question
          ...
          : "How likely is it that you would recommend our agency to a friend or colleague?";
        thanks = comp.s_body.s.thanks
          ? module.exports.keywords(comp.s_body.s.thanks, comp, cust)
          : "Thank you so much for your feedback.";
      }
      let cor_id = Default.cHash(comp.cor_id);
      let c_id = Default.cHash(comp.c_id);
      let cus_id = cust.id
        ? Default.cHash(cust.id)
        : Default.cHash(cust.cus_id);
        ...
        <body style="
            ...
            ${
              one === "1"
                ? `${
                    comp.logo
                      ? `<img src='${comp.logo}' alt='Company Logo' style="max-width: 200px;" />`
                      : ""
                  }`
                : ``
            }
                ...
                <div style="padding: .5% 2.5% 0 0; margin-left: 0; text-align: center;">
					...
					<p style='margin-top: 3.5%; font-size: 1.25em;;'>${
            thanks
              ? thanks.includes("\n")
                ? thanks.split("\n").join("<br/>\n")
                : thanks
            ...
            three === "1"
              ? `
					...
					<p style='margin: .25% 0; font-size: 1em; line-height: 95%;'>${
            comp.company_name
          }</p>
					<p style='margin: .25% 0; font-size: 1em; line-height: 95%;'>${
            comp.address.street
					...
					<p style='margin: .25% 0; font-size: 1em; line-height: 95%;'>${
            comp.address.state
          }, USA, ${comp.address.zip}</p>
					<p style='margin: .25% 0; font-size: 1em; line-height: 95%;'>${module.exports.formatPhoneNumber(
            comp.phone.phone
          )}</p>
					</div>
              ...
              ? `
				...
				<div style='display= inline-block; width= 100%; margin= 2.5 % 0; textAlign= left;'>
					${
            comp.logo
              ? `<img src='${comp.logo}' alt='Company Logo' style="max-width: 19%;" />`
              : ""
          }
				</div>
                <div style='display: inline-block; width: 80%; text-align: left; '>
                    <p style='margin: .5% 0; font-size: 1em; line-height: 95%;'>${
                      comp.company_name
                    }</p>
                    <p style='margin: .5% 0; font-size: 1em; line-height: 95%;'>${
                      comp.address.street
                    ...
                    <p style='margin: .5% 0; font-size: 1em; line-height: 95%;'>${module.exports.formatPhoneNumber(
                      comp.phone.phone
                    )}</p>
                </div>
                </div>
              ...
              ? `<div style="margin-top: 5%;">
						<div style="width:100%; text-align: left; ">${comp.signature}</div>
						<a href="${landing_link}feedback/unsubscribe/${cor_id}/${cus_id}/${c_id}" style='text-decoration: underline; display: inline-block;'>
						<p>Unsubscribe</p>
					</a>
							</div>`
  ...
  text: (comp, cust) => {
    try {
      return `
			...
			\n		
			1 - ${landing_link}feedback/rating/${comp.cor_id}/${cust.cus_id}/1/email/${
        comp.c_id
      }
			\n		
			2 - ${landing_link}feedback/rating/${comp.cor_id}/${cust.cus_id}/2/email/${
        comp.c_id
      }
			\n		
			3 - ${landing_link}feedback/rating/${comp.cor_id}/${cust.cus_id}/3/email/${
        comp.c_id
      }
			\n		
			4 - ${landing_link}feedback/rating/${comp.cor_id}/${cust.cus_id}/4/email/${
        comp.c_id
      }
			\n		
			5 - ${landing_link}feedback/rating/${comp.cor_id}/${cust.cus_id}/5/email/${
        comp.c_id
      }
			\n		
        `;
