...
class SentStatsGraph extends Component {
	...
	render() {
		...
		return (
			<div style={{ height, width, display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', border: 'solid gray 1px' }}>
				{/* Opened */}
				<div
					style={{
				...
				>
					...
					>
						...
						<div
							...
							data-for="feedback"
						>
							{percent.feedback >= 50 ? `${percent.feedback}%` : ''}
						</div>
						<div
							...
							className="click"
						/>
						{/* {percent.click >= 30 ? `${percent.click}%` : ''} */}
					</div>
				</div>
