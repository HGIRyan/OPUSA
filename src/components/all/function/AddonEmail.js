...
class Addon extends Component {
	...
	text(v) {
		if (v.includes('<br/>')) {
			return v
				.split('<br/>')
				.map(e => this.keywords(e, this.props.og, { first_name: 'Ryan', last_name: 'Hutch', email: process.env.REACT_APP_DEV_EMAIL, id: '2' }).concat('\n'))
				.join(' ');
		} else return v;
	}
			...
			<EmailContainer>
				...
				>
					...
					<div style={{ margin: '10% 5% 0 5%' }}>
						{/*Footer*/}
						<hr />
						Copyright © 2020 {process.env.REACT_APP_COMPANY_NAME}, All rights reserved.
						<br />
						<br />
